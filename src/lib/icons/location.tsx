	...
	return (
		<svg
			...
			<path
				fillRule='evenodd'
				clipRule='evenodd'
				d='M14.5103 10.7105C14.5103 9.32923 13.391 8.20999 12.0097 8.20999C10.6295 8.20999 9.51025 9.32923 9.51025 10.7105C9.51025 12.0908 10.6295 13.21 12.0097 13.21C13.391 13.21 14.5103 12.0908 14.5103 10.7105Z'
				stroke='#455A64'
				strokeWidth='1.5'
				strokeLinecap='round'
