export default function DownCircle(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width='24'
			height='24'
			...
			<g id='Iconly/Curved/Arrow - Down Circle'>
				<g id='Arrow - Down Circle'>
					...
					<path
						id='Stroke 3'
						d='M8.52856 10.5581C8.52856 10.5581 10.9206 14.0441 12.0006 14.0441C13.0806 14.0441 15.4706 10.5581 15.4706 10.5581'
						stroke='currentColor'
						strokeWidth='1.5'
						strokeLinecap='round'
						strokeLinejoin='round'
